...
%==========================================================================
% 2018-01-09   revised by Erik Chang (audachang@gmail.com)
%       to accommodate multiple level struct defined in ini
    ...
    if ( s(1)=='[' ) && (s(end)==']' )
        ...
        val = CleanValue(val);
            if ~isempty(CurrMainField)
                ...
                Result.(matlab.lang.makeValidName(par)) = val;
                %Result.(par) = val;
            end
        end
end
